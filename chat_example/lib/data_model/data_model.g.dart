...
class _$ChatSerializer implements StructuredSerializer<Chat> {
  final Iterable<Type> types = new BuiltList<Type>([Chat, _$Chat]);
...
class _$LoginSerializer implements StructuredSerializer<Login> {
  final Iterable<Type> types = new BuiltList<Type>([Login, _$Login]);
...
class _$StatusSerializer implements StructuredSerializer<Status> {
  final Iterable<Type> types = new BuiltList<Type>([Status, _$Status]);
...
class _$StatusTypeSerializer implements PrimitiveSerializer<StatusType> {
  final Iterable<Type> types = new BuiltList<Type>([StatusType]);
...
class _$ListUsersSerializer implements StructuredSerializer<ListUsers> {
  final Iterable<Type> types = new BuiltList<Type>([ListUsers, _$ListUsers]);
...
class _$LoginResponseSerializer implements PrimitiveSerializer<LoginResponse> {
  final Iterable<Type> types = new BuiltList<Type>([LoginResponse]);
...
class _$ShowChatSerializer implements StructuredSerializer<ShowChat> {
  final Iterable<Type> types = new BuiltList<Type>([ShowChat, _$ShowChat]);
...
class _$ListUsersResponseSerializer
  ...
  final Iterable<Type> types =
      new BuiltList<Type>([ListUsersResponse, _$ListUsersResponse]);
...
class _$Chat extends Chat {
  ...
  _$Chat._({this.text, this.targets}) : super._() {
    ...
    if (targets == null) throw new ArgumentError('null targets');
  }
  ...
  int get hashCode {
    return hashObjects([text, targets]);
  }
...
class _$Login extends Login {
  ...
  _$Login._({this.username, this.password}) : super._() {
    if (username == null) throw new ArgumentError('null username');
    if (password == null) throw new ArgumentError('null password');
  }
  ...
  int get hashCode {
    return hashObjects([username, password]);
  }
...
class _$Status extends Status {
  ...
  _$Status._({this.message, this.type}) : super._() {
    if (message == null) throw new ArgumentError('null message');
  ...
  int get hashCode {
    return hashObjects([message, type]);
  }
...
class _$ListUsers extends ListUsers {
  ...
  _$ListUsers._({this.statusTypes}) : super._() {
    if (statusTypes == null) throw new ArgumentError('null statusTypes');
  }
  ...
  int get hashCode {
    return hashObjects([statusTypes]);
  }
...
class _$ShowChat extends ShowChat {
  ...
  _$ShowChat._({this.username, this.private, this.text}) : super._() {
    if (username == null) throw new ArgumentError('null username');
    if (private == null) throw new ArgumentError('null private');
    if (text == null) throw new ArgumentError('null text');
  }
  ...
  int get hashCode {
    return hashObjects([username, private, text]);
  }
...
class _$ListUsersResponse extends ListUsersResponse {
  ...
  _$ListUsersResponse._({this.statuses}) : super._() {
    if (statuses == null) throw new ArgumentError('null statuses');
  }
