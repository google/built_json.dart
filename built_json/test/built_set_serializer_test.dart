...
// specific ordering. In fact, these tests are exactly the BuiltListSerializer tests
// with "list" replaced by "set".
void main() {
  ...
  group('BuiltSet with known specifiedType and correct builder', () {
    ...
    final serializers = (new Serializers().toBuilder()
      ..addBuilderFactory(specifiedType, () => new SetBuilder<int>())).build();
    final serialized = [1, 2, 3];
